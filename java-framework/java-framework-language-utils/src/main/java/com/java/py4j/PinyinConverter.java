...
import com.java.py4j.util.ArrayUtils;
import com.java.py4j.util.StringUtils;
import com.java.py4j.voc.Py4jDictionary;
...
public class PinyinConverter implements Converter {
	...
	public String getPinyin(String chinese) throws IllegalPinyinException {
		...
		for(int i=0;i<chs.length;i++){
			...
			if(py_arr.length==1){
				py_sb.append(convertInitialToUpperCase(py_arr[0]).toLowerCase());
				py_sb.append(" ");
				...
				py_sb.append(convertInitialToUpperCase(resultPy).toLowerCase());
				py_sb.append(" ");
			}
		}
